...
```{r, fig.cap="\\label{plot2}These figures show the distribution of student GRE quant scores, GRE verbal scores, GRE writing scores, and undergraduate GPA",fig.width=6, fig.height=4,echo=FALSE}
#Clean Data
...
ggplot(aes(x = mean_GRE, y = mean_gpa)) + geom_point(aes(color = "RED", alpha = 0.001)) +
  labs(titles = "Relationship between GPA and GRE Score",
       y = "GPA",
       x = "GRE Score",
       caption = "Fig *. displays the mean GPA and the mean GRE scores of each schools in Top 10 CS program accordingly")
```
